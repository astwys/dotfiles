apiKey: '026c2c462b4463e13be4604e3526b494' # put your forcast.io api key inside the quotes here
...
afterRender: (domEl) ->
  geolocation.getCurrentPosition (e) =>
    ...
    if (e.address.city is 'Wallern im Burgenland')
    	e.address.city = 'Wallern'
